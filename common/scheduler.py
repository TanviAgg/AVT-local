...
class CosineLR(torch.optim.lr_scheduler.CosineAnnealingLR):
    ...
    def get_lr(self, *args, **kwargs):
        if self.last_epoch < self.T_max:
            # print("custominfoLR: here getting LR, maybe 0")  # custominfo
            ...
            print("custominfoLR: here setting LR 0: 0.0000001")  # custominfo
            return [0.0000001 for _ in self.optimizer.param_groups]
